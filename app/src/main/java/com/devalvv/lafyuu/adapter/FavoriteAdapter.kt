package com.deva.lafyuu.adapter
...
import com.deva.lafyuu.ProductDetailActivity
import com.deva.lafyuu.R
...
class FavoriteAdapter(val context: Context, val itemList: List<ItemData>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val addIcon: ImageView = view.findViewById(R.id.delete_icon)
    }
